...
import DeletedReservationAlert from "./DeletedReservationAlert";
        ...
        sortedGroups.map(([groupId, group]) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`reservation-list ${expandedGroup === groupId ? "expanded" : "collapsed"}`}
              >
                {group.map((reservation, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p><strong>출발 날짜:</strong> {reservation.fdepartureTime}</p>
                      <p><strong>좌석 번호:</strong> {reservation.sname} {reservation.sspot} ({reservation.sclass})</p>
